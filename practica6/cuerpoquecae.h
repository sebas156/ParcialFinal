#ifndef CUERPOQUECAE_H
#define CUERPOQUECAE_H


class CuerpoQueCae
{
public:
    CuerpoQueCae(float posX_, float posY_, float velX_, float velY_, float masa_, float radio_, float K_, float e_);
    float get_posX();
    float get_posY();
    float get_Radio();
    float get_e();
